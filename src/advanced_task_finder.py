...
class AdvancedTaskFinder:
    ...
    def save_results(self, report, common_tasks_simple):
        ...
        try:
            ...
            print(f" Errore salvataggio report dettagliato: {e}")
        ...
        try:
            ...
            print(f" Errore salvataggio lista semplice: {e}")
...
if __name__ == "__main__":
    ...
    print("1. Ricerca task presenti in TUTTI i linguaggi:")
    finder.find_and_analyze_all()

    print("\n" + "=" * 60)

    # Ricerca flessibile (80% dei linguaggi)
    print("2. Ricerca flessibile (80% dei linguaggi):")
